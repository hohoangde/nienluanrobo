...
void  doline(){
 ...
 else if( sen_phai.read()<linechuan && sen_giua.read()<linechuan){
   dunglai();
   delay(1000);
   motor_left();
   delay(1000);
 
 }else if(sen_trai.read()<linechuan && sen_giua.read()<linechuan){
   dunglai();
   delay(1000);
   motor_phai();
   delay(1000);
...
void loop() {
 if((sen_trai.read()<linechuan||sen_right.read()<linechuan||sen_giua.read()<linechuan)&& khoangcach()> 15 ){
     doline();
 }
